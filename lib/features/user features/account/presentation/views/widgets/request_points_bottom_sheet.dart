...
import 'package:booking_app/features/user%20features/account/presentation/views/widgets/point_request_form_content.dart';
import 'package:booking_app/features/user%20features/account/presentation/views/widgets/point_request_header.dart';
...
class RequestPointsBottomSheetState extends State<RequestPointsBottomSheet> {
  ...
  Future<void> _submitRequest() async {
    ...
    await context.read<RequestPointsCubit>().requestPoints(
      data: {
        'amount': points,
        'transaction_id': transferIdController.text.trim(),
      },
    );
  }
